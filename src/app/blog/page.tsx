    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black py-16">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <h1
            className="text-6xl md:text-7xl font-bold mb-2 leading-[1.2] pb-2 font-sans overflow-visible"
            style={{
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-0">
            {pageData.heroSubtitle}
          </p>
        </div>
      </section>

      {/* Stats Section (Grid Only, now directly after hero) */}
      <section className="pt-2 pb-20 bg-gradient-to-r from-gray-900 to-black relative overflow-hidden">
      ...
      {/* Featured Case Study (Animated) */}
      <FeaturedCaseStudyWrapper
        title={pageData.featuredCaseStudy.title}
        subtitle={pageData.featuredCaseStudy.subtitle}
        highlights={pageData.featuredCaseStudy.highlights}
        ctaLabel={pageData.featuredCaseStudy.ctaLabel}
        ctaLink={"/blog/how-drill-doctor-sold-2-million-units-through-long-form-infomercials/"}
      />
